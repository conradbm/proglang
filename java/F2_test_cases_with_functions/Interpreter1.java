...
public class Interpreter1 {
	...
	// FOR STORING DATA
	public static ArrayList<Tok> tokenList;
	...
	/*******************************************************/
       ...
       public void CMDPRINTX(){
            ...
            if(tokenList.get(i).tokenType.equals("N")){
                ...
                String infoMessage = "The value of your literal is: " + tokenList.get(i).tokenValue;
                ...
                String infoMessage = "The value of variable: " + tokenList.get(i).tokenValue + " is: " + variableList.findVariable(tokenList.get(i).tokenValue);
                JOptionPane.showMessageDialog(null, infoMessage, "InfoBox: Information" , JOptionPane.INFORMATION_MESSAGE);
                //store this value and pass it up the tree
            }
        }
       ...
       public void CMDINPUTX(){
          ...
          String inputValue = JOptionPane.showInputDialog("Please input a value of " + dynamic_name);
          dynamic_value = Integer.parseInt(inputValue);
       ...
       public void CMDIFX(){
           ...
           for(Tok t : tokenList){
               System.out.println("alltokloop:" + t.tokenValue + " " + t.tokenType);
           }
           i++; // ifx
           ...
           if(tokenList.get(i).tokenType == "F"){
               ...
               //for every expression in that functions expressionlist
                for(int j = 0; j < currFunc.statementList.size(); j++){ //expressions in main
                    ArrayList<Tok> AL = new ArrayList<>();
			...
			for(int k = 0; this.expIndex <= this.expMaxLength; k++){
				...
				this.getToken();
				Tok t = new Tok(this.tok, this.tokType);
		...
		if(tokenList.get(i).tokenType == "V"){
			...
			if(tokenList.get(i).tokenValue.equals("=")){
				...
				//variableList.printList();
                            ...
                            System.out.println("a"+ tokenList.get(i).tokenValue +"a");
